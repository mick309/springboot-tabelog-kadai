...
INSERT INTO shop (id, category_id, shop_name, image_name, description, price_upper, price_lower, hours_open, hours_close, closed_day, postal_code, address, phone_number)
SELECT 2, 2, '居酒屋 SAMURAI', 'house02.jpg', '最寄り駅から徒歩10分。数多いメニューでファミリーでもお食事いただけます。', 2000, 6000, '17:00:00', '23:00:00', '月曜日', '030-0945', '青森県青森市桜川X-XX-XX', '012-345-678'
WHERE NOT EXISTS (SELECT 1 FROM shop WHERE id = 2);

INSERT INTO shop (id, category_id, shop_name, image_name, description, price_upper, price_lower, hours_open, hours_close, closed_day, postal_code, address, phone_number)
SELECT 3, 3, 'SAMURAI屋', 'house03.jpg', '最寄り駅から徒歩10分。土佐料理店。皿鉢料理をはじめ土佐の地元料理が楽しめます。', 3000, 8000, '11:00:00', '22:00:00', '火曜日', '029-5618', '岩手県和賀郡西和賀町沢内両沢X-XX-XX', '012-345-678'
WHERE NOT EXISTS (SELECT 1 FROM shop WHERE id = 3);

INSERT INTO shop (id, category_id, shop_name, image_name, description, price_upper, price_lower, hours_open, hours_close, closed_day, postal_code, address, phone_number)
SELECT 4, 4, 'SAMURAI座衛門', 'house04.jpg', '最寄り駅から徒歩10分。肉飯の店。ローストビーフ丼は絶品です。', 1000, 3000, '11:00:00', '21:00:00', '火曜日', '989-0555', '宮城県刈田郡七ヶ宿町滝ノ上X-XX-XX', '012-345-678'
WHERE NOT EXISTS (SELECT 1 FROM shop WHERE id = 4);

INSERT INTO shop (id, category_id, shop_name, image_name, description, price_upper, price_lower, hours_open, hours_close, closed_day, postal_code, address, phone_number)
SELECT 5, 5, 'SAMURAIcafe', 'house05.jpg', '最寄り駅から徒歩10分。自然豊かで閑静な場所にあります。ゆったりとした時間を過ごしていただけます。', 1000, 3000, '08:00:00', '20:00:00', '水曜日', '018-2661', '秋田県山本郡八峰町八森浜田X-XX-XX', '012-345-678'
WHERE NOT EXISTS (SELECT 1 FROM shop WHERE id = 5);

INSERT INTO shop (id, category_id, shop_name, image_name, description, price_upper, price_lower, hours_open, hours_close, closed_day, postal_code, address, phone_number)
SELECT 6, 6, 'レストラン SAMURAI', 'house06.jpg', '最寄り駅から徒歩10分。カジュアルレストランの店。ファミリーでもお一人様でも。', 3000, 8000, '10:00:00', '23:00:00','火曜日', '999-6708', '山形県酒田市泉興野X-XX-XX', '012-345-678'
WHERE NOT EXISTS (SELECT 1 FROM shop WHERE id = 6);

INSERT INTO shop (id, category_id, shop_name, image_name, description, price_upper, price_lower, hours_open, hours_close, closed_day, postal_code, address, phone_number)
SELECT 7, 7, 'SAMURAI天津', 'house07.jpg', '最寄り駅から徒歩10分。自然豊かで閑静な場所にあります。本場の中国料理を楽しんでいただけます。', 5000, 10000, '12:00:00', '22:00:00', '月曜日',  '969-5147', '福島県会津若松市大戸町芦牧X-XX-XX', '012-345-678'
WHERE NOT EXISTS (SELECT 1 FROM shop WHERE id = 7);

INSERT INTO shop (id, category_id, shop_name, image_name, description, price_upper, price_lower, hours_open, hours_close, closed_day, postal_code, address, phone_number)
SELECT 8, 8, 'SAMURAIラーメン', 'house08.jpg', '最寄り駅から徒歩10分。路地裏の隠れ店的な場所にあります。おすすめは豚骨ラーメンです。', 1000, 3000, '11:00:00', '00:00:00', '日曜日', '310-0021', '茨城県水戸市南町X-XX-XX', '012-345-678'
WHERE NOT EXISTS (SELECT 1 FROM shop WHERE id = 8);

INSERT INTO shop (id, category_id, shop_name, image_name, description, price_upper, price_lower, hours_open, hours_close, closed_day, postal_code, address, phone_number)
SELECT 9, 9, 'SAMURAI鳥や', 'house09.jpg', '最寄り駅から徒歩10分。放し飼いの地鶏が楽しめるお店。水炊きもおすすめです。', 3000, 10000, '18:00:00', '23:00:00', '水曜日', '323-1101', '栃木県下都賀郡藤岡町大前X-XX-XX', '012-345-678'
WHERE NOT EXISTS (SELECT 1 FROM shop WHERE id = 9);

INSERT INTO shop (id, category_id, shop_name, image_name, description, price_upper, price_lower, hours_open, hours_close, closed_day, postal_code, address, phone_number)
SELECT 10, 10, 'シーサイドSAMURAI', 'house10.jpg', '最寄り駅から徒歩10分。海なし県なのにシーサイド。魚介料理を提供しています。', 5000, 10000, '12:00:00', '21:00:00', '月曜日', '370-0806', '群馬県高崎市上和田町X-XX-XX', '012-345-678'
WHERE NOT EXISTS (SELECT 1 FROM shop WHERE id = 10);

INSERT INTO shop (id, category_id, shop_name, image_name, description, price_upper, price_lower, hours_open, hours_close, closed_day, postal_code, address, phone_number)
SELECT 11, 11, 'イタ飯SAMURAI', 'house11.jpg', '最寄り駅から徒歩10分。本格的イタリアン料理のお店。イタリアの三ツ星レストラン出身のシェフの料理ご賞味あれ。',6000, 20000, '11:00:00', '21:00:00', '木曜日', '344-0125', '埼玉県春日部市飯沼X-XX-XX', '012-345-678'
WHERE NOT EXISTS (SELECT 1 FROM shop WHERE id = 11);

INSERT INTO shop (id, category_id, shop_name, image_name, description, price_upper, price_lower, hours_open, hours_close, closed_day, postal_code, address, phone_number)
SELECT 12, 12,  'ヴィラSAMURAI', 'house12.jpg', '最寄り駅から徒歩10分。自然豊かで閑静な場所にあります。ゆったりとお食事できます。', 3000, 10000, '11:00:00', '22:00:00', '水曜日', '272-0011', '千葉県市川市高谷新町X-XX-XX', '012-345-678'
WHERE NOT EXISTS (SELECT 1 FROM shop WHERE id = 12);

INSERT INTO shop (id, category_id, shop_name, image_name, description, price_upper, price_lower, hours_open, hours_close, closed_day, postal_code, address, phone_number)
SELECT 13, 13,  'SAMURAIパレス', 'house13.jpg', '最寄り駅から徒歩10分。ウェディングレストランのお店。ウエディング、パーティーなど宴会にご利用ください。', 8000, 20000, '10:00:00', '20:00:00', '水曜日', '130-0023', '東京都墨田区立川X-XX-XX', '012-345-678'
WHERE NOT EXISTS (SELECT 1 FROM shop WHERE id = 13);

INSERT INTO shop (id, category_id, shop_name, image_name, description, price_upper, price_lower, hours_open, hours_close, closed_day, postal_code, address, phone_number)
SELECT 14, 14, 'ロッジ SAMURAI', 'house14.jpg', '最寄り駅から徒歩10分。自然豊かで閑静な場所にあります。ゆったりとお食事できます。', 3000, 15000, '11:00:00', '21:00:00', '日曜日', '240-0006', '神奈川県横浜市保土ヶ谷区星川X-XX-XX', '012-345-678'
WHERE NOT EXISTS (SELECT 1 FROM shop WHERE id = 14);

INSERT INTO shop (id, category_id, shop_name, image_name, description, price_upper, price_lower, hours_open, hours_close, closed_day, postal_code, address, phone_number)
SELECT 15, 15, 'SAMURAI館', 'house15.jpg', '最寄り駅から徒歩10分。スペイン料理が楽しめます。ワインもおすすめ。', 5000, 10000, '12:00:00', '22:00:00', '木曜日',  '950-0201', '新潟県新潟市駒込X-XX-XX', '012-345-678'
WHERE NOT EXISTS (SELECT 1 FROM shop WHERE id = 15);

INSERT INTO shop (id, category_id, shop_name, image_name, description, price_upper, price_lower, hours_open, hours_close, closed_day, postal_code, address, phone_number)
SELECT 16, 16, 'SAMURAI山荘', 'house16.jpg', '最寄り駅から徒歩10分。自然豊かで閑静な場所にあります。山小屋風の建物でゆったりとお食事できます。', 3000, 6000, '08:00:00', '19:00:00', '水曜日', '939-8155', '富山県富山市江本X-XX-XX', '012-345-678'
WHERE NOT EXISTS (SELECT 1 FROM shop WHERE id = 16);

INSERT INTO shop (id, category_id, shop_name, image_name, description, price_upper, price_lower, hours_open, hours_close, closed_day, postal_code, address, phone_number)
SELECT 17, 17, 'SAMURAIの家', 'house17.jpg', '最寄り駅から徒歩10分。おもわずただいまと言いたくなるような家庭的な雰囲気の店。一品料理が数多く並んでいます。', 3000, 8000, '18:00:00', '01:00:00', '月曜日', '929-0111', '石川県能美市吉原町X-XX-XX', '012-345-678'
WHERE NOT EXISTS (SELECT 1 FROM shop WHERE id = 17);

INSERT INTO shop (id, category_id, shop_name, image_name, description, price_upper, price_lower, hours_open, hours_close, closed_day, postal_code, address, phone_number)
SELECT 18, 18, 'SAMURAIPOR', 'house18.jpg', '最寄り駅から徒歩10分。ポルトガル料理の店。素朴で優しいポルトガル家庭料理が楽しめます。', 8000, 15000, '17:00:00', '23:00:00', '月曜日', '910-2354', '福井県福井市東天田町X-XX-XX', '012-345-678'
WHERE NOT EXISTS (SELECT 1 FROM shop WHERE id = 18);

INSERT INTO shop (id, category_id, shop_name, image_name, description, price_upper, price_lower, hours_open, hours_close, closed_day, postal_code, address, phone_number)
SELECT 19, 19, 'SAMURAIBrazil', 'house19.jpg', '最寄り駅から徒歩10分。ブラジル料理の店。人気のシェラスコや国民食フェイジョアーダなど代表的グルメから珍グルメまで。', 3000, 10000, '18:00:00', '01:00:00', '水曜日', '403-0003', '山梨県富士吉田市大明見X-XX-XX', '012-345-678'
WHERE NOT EXISTS (SELECT 1 FROM shop WHERE id = 19);

INSERT INTO shop (id, category_id, shop_name, image_name, description, price_upper, price_lower, hours_open, hours_close, closed_day, postal_code, address, phone_number)
SELECT 20, 20, 'SAMURAI軒', 'house20.jpg', '最寄り駅から徒歩10分。コロッケやオニオンスープ、ハンバーグなど人気メニュー目白押し。ランチタイムは行列覚悟で。', 3000, 10000, '08:00:00', '21:00:00', '金曜日', '395-0017', '長野県飯田市東新町X-XX-XX', '012-345-678'
